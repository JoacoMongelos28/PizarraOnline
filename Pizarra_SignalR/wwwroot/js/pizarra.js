...
function unirseASala() {
    ...
    document.getElementById("h1-en-sala").textContent = 'Te uniste a ' + salaActual;
...
function aplicarCambios(e) {
    if (e.matches) {
        let contenedor = document.getElementById("contenedor-principal");
        contenedor.classList.remove("container");

        let contenedorPizarra = document.getElementById("divPizarra");
        contenedorPizarra.classList.remove("row");

        let contenedorUsuarios = document.getElementById("usuariosContainer");
        contenedorUsuarios.classList.remove("mt-4");

        let contenedorChat = document.getElementById("divChat");
        contenedorChat.classList.remove("mt-4");
    } else {
        let contenedor = document.getElementById("contenedor-principal");
        contenedor.classList.add("container");

        let contenedorPizarra = document.getElementById("divPizarra");
        contenedorPizarra.classList.add("row");

        let contenedorUsuarios = document.getElementById("usuariosContainer");
        contenedorUsuarios.classList.add("mt-4");

        let contenedorChat = document.getElementById("divChat");
        contenedorChat.classList.add("mt-4");
    }
}

mediaQuery.addEventListener("change", aplicarCambios);

aplicarCambios(mediaQuery);